...
interface FlightSearchDao {
    ...
    @Query("SELECT EXISTS(SELECT * FROM favorite WHERE departure_code = :departureIataCode AND destination_code = :destinationIataCode)")
    suspend fun isFavoriteRouteExist(departureIataCode: String, destinationIataCode: String): Boolean
